...
import com.example.datvtd.weather.Adapter.ViewPagerAdapter;
...
public class MainActivity extends AppCompatActivity implements TodayWeatherFagment.OnFragmentInteractionListener {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(TodayWeatherFagment.getInstance(),"Today");
